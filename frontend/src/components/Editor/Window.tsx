...
export default function Window({
    ...
    return <motion.div 
        ...
        <motion.div className="o-window justify-end flex bg-[var(--primary)] sticky top-0" onPointerDown={(e)=>dragControls.start(e)}>
            <button className="text-[var(--bg)] font-semibold border-l border-[var(--bg)] hover:bg-[var(--bg)]/25 sticky " onClick={()=>closeWindow(windowID)}>
